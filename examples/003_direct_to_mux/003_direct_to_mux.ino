...
// Initialize the sensor in Direct-to-DE_MUX mode
FSR16x16_BNL sensor(DIRECT, ROW_PINS, DE_MUX, COL_PINS, OUTPUT_PIN);

void setup() {
    Serial.begin(115200);
    Serial.println("FSR16x16_BNL Direct-to-DE_MUX Example Starting...");
