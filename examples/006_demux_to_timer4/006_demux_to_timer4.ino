...
// Initialize the sensor in DE_MUX-to-Timer4 mode
FSR16x16_BNL sensor(DE_MUX, ROW_PINS, TIMER4, COL_CLEAR_PIN, COL_CLEAR_TYPE, COL_CLOCK_PIN, COL_CLOCK_TYPE, OUTPUT_PIN);

void setup() {
    Serial.begin(115200);
    Serial.println("FSR16x16_BNL DE_MUX-to-Timer4 Example Starting...");
